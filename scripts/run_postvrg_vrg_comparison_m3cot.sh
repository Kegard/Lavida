...
OUTPUT_ROOT="${OUTPUT_ROOT:-M3CoT/PostVRG/outputs/vrg_comparison_m3cot_seed${SEED}_noise${NOISE_STEP}_alpha${VCD_REFILL_ALPHA}_k${REFILL_GUIDANCE_STEPS}_n${LIMIT}}"
...
run_experiment() {
  local weak_mode="$1"
  local name="full_cond_vs_${weak_mode}"
